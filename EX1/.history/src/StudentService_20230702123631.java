...
public class StudentService {
    public void printStudentTable(ArrayList<Student> students) {
        ...
        for (Student student : students) {
            ...
            String limitedName = limitStringLength(name, 19);
            String limitedSemester = limitStringLength(semester, 6);
            String limitedCourse = limitStringLength(course, 20);

            System.out.printf("| %-19s| %-6s| %-20s|\n", limitedName, limitedSemester, limitedCourse);
            System.out.println("-------------------------------------------------------");
        }
    }
