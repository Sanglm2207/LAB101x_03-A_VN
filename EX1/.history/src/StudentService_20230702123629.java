...
public class StudentService {
    public void printStudent(ArrayList<Student> students) {
        ...
        for (Student student : students) {
            ...
            String formattedName = String.format("| %-18s", name);
            String formattedSemester = String.format("| %-7s", semester);
            String formattedCourse = String.format("| %-20s", course);
    ...
    private String limitStringLength(String text, int maxLength) {
