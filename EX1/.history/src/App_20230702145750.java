        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    System.out.print("Nhập tên sinh viên hoặc một phần của tên: ");
                    String searchName = scanner.nextLine();
                    ArrayList<Student> searchResults = studentService.searchAndSortStudents(students, searchName);
                    ...
                    break;
                case 3:
                    System.out.print("Nhập ID của sinh viên muốn cập nhật hoặc xóa: ");
                    String id = scanner.nextLine();
                    studentService.updateOrDeleteStudent(students, id, scanner);
                    break;
                case 4:
