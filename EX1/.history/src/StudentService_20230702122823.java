...
public class StudentService {
    public void printStudentTable(ArrayList<Student> students) {
        System.out.println("Kết quả tìm kiếm và sắp xếp:");
        System.out.println("Tên sinh viên\t\tHọc kỳ\t\tTên khóa học");
        System.out.println("----------------------------------------");
        ...
        for (Student student : students) {
            ...
            String formattedSemester = String.format("%-10s", semester);
            String formattedCourse = String.format("%-15s", course);

            System.out.println(formattedName + "\t" + formattedSemester + "\t" + formattedCourse);
        }
    }
